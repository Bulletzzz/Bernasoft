                                    ...
                                    <tbody id="tabcategorias">
                                        @foreach($categorias as $categoria)
                                            <tr>
                                                    ...
                                                    <td><a href="/maquinas/edit/{{$categoria->id}}"><i class="fa-solid fa-pen-to-square"></i></a></td>
                                                    <td>
        ...
        @foreach($maquinas as $maquina)
            <tr>
                    <td><img src="${produtos[qntprods-1].img}" alt="">{{$maquina->title}}</td>
                                ...
                                <td>{{$maquina->cost}}</td>
                                <td><span class="status">@if($maquina->status == 1) Ativo @else Inativo @endif</span></td>
